...
public class Queue_Menu 
{
	...
	@FindBy(xpath="//*[@id='content']/div/div/div/ul/li[5]/ul[1]/li[3]") WebElement click_twi_profile;   
	
	@FindBy(xpath="//*[@id='content']/div/div/div/ul/li[10]") WebElement click_calender_view;
	@FindBy(xpath="//*[@id='content']/div/div/div/ul/li[9]") WebElement click_calender_Listview;
